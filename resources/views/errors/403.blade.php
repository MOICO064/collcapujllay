...
<head>
    ...
    <title>Error 403 - {{ config('app.name', 'Collcapujllay') }}</title>
...
<body class="bg-gradient-to-b from-slate-50 via-mint/5 to-slate-100 text-slate-900 min-h-screen flex items-center justify-center">
    <div class="text-center">
        ...
        <h1 class="text-8xl font-bold text-forest mb-4">403</h1>
        <p class="text-2xl mb-8 text-jade">Acceso denegado</p>
