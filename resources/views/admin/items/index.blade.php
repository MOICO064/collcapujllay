    ...
    <div class="bg-white shadow-lg rounded-lg p-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6">
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 w-full sm:w-auto">
                ...
                <a href="{{ route('items.create') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded flex items-center justify-center">
        ...
        <table id="items-table" class="display responsive w-full text-sm text-left text-gray-500">
...
@push('scripts')
<script src="{{ asset('js/admin/items/index.js') }}"></script>
@endpush
